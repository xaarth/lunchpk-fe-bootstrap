    ...
    <section style={{ padding: '5rem 0' }}>
      <Container>
        <div className='mb-5'>
          ...
          <p className='mb-0'>
            This policy explains how we, lunch.pk, use your personal information
            which you provide to us when using our service, including but not
            limited to our website and mobile applications (apps).
          </p>
        </div>
        ...
        <TosPoint title='Cookies and Google Analytics'>
          ...
          <p>
            ...
            in the manner and for the purposes set out above. You can also
            prevent Google from collecting information (including your IP
        ...
        <TosPoint title='Access to your information'>
          <p>
            ...
            this information – info@lunch.pk. There will be a small charge for
