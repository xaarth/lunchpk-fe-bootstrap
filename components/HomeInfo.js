  ...
  >
    <Container>
      ...
      <p style={{ fontWeight: '500' }}>
        WE SAVE YOU FROM UNHEALTHY TOXIC FOOD CHOICES BY SERVING YOU REAL <br />
        HEALTHY HOMEMADE FOOD AT YOUR DOORSTEP.
      </p>
      <p style={{ fontWeight: '500' }}>
        Not only health is most neglected aspect of our life, but we have tons
        of unhealthy toxic food choices around us, <br /> making it hard to live
        a healthy life. That is why Obesity, diabetes and heart diseases have
        become <br /> so common in our lives.
      </p>
